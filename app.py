...
def process_excel_route():
    ...
    # Inicializa uma lista para armazenar DataFrames de cada arquivo
    df_list = []
    ...
    # Define a função para unificar as linhas agrupadas
...
def index():
    limpar_variaveis_globais()# Limpa as variáveis globais para garantir que a página inicial comece vazia
